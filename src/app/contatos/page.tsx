...
export default function Contatos() {
    return (
        <>
            <NavBar></NavBar>
            <main className="flex w-screen h-screen px-[20px] justify-around items-center bg-gray-950">
                ...
                w-[60vw] p-5 justify-start absolute left-0 h-screen">
                    <main className="">
                        ...
                        <section className="flex flex-col capitalize">
                            ...
                            hover:bg-green-700 transition-all duration-300 hover:translate-x-3 sm:py-2 sm:w-[150px] md:w-[200px]">Enviar</Link>
                        </section>
                    </main>
                </div>
                ...
                transition-all duration-500 hover:drop-shadow-[0_0_40px_#018001] bg-center sm:hidden md:block"/>
            </main>
            <Footer></Footer>
        </>
    )
