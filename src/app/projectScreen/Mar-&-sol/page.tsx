            ...
            <main className="flex flex-col w-screen h-screen px-[20px] p-5 bg-gray-900">
                ...
                xl:justify-between xl:flex-row xl:items-center">
                    ...
                    <div className="bg-[url(../assets/Mar&Sol-image.png)] bg-cover sm:w-[285px] sm:h-[180px] md:w-[650px] md:h-[300px]
                        ...
                        hover:drop-shadow-[0_0_40px_#99289c] drop-shadow-[0_0_10px_#99289c] xl:hover:w-[800px] sm:hover:w-[350px] md:hover:w-[680px] "/>

                </div>

                <div className="md:w-[400px] sm:w-[250px] flex items-center justify-between m-auto">

                    <Link href={"https://login-react-nine.vercel.app"} className="text-white md:text-lg sm:text-sm font-semibold hover:text-violet-800
                        transition-all duration-300">Visitar Projeto</Link>

                    <Link href={"https://github.com/sidgabrielmoura/login-react"} target="_blank" className="text-white md:text-lg sm:text-sm font-semibold hover:text-violet-800
